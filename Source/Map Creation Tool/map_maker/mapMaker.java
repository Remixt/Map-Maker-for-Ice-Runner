...
public class mapMaker {
	...
	private void initialize() {
		...
		btnWall.setSelectedIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Wall_Selected.png")));
		btnWall.setBackground(Color.BLACK);
		btnWall.setIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Wall.png")));
		toolBar.add(btnWall);

		JButton btnPlayer = new JButton("");
		btnPlayer.setToolTipText("Player Start");
		btnPlayer.setBackground(Color.BLACK);
		btnPlayer.setSelectedIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Player_Selected.png")));
		...
		btnGoal.setSelectedIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Goal_Selected.png")));
		...
		btnEmpty.setSelectedIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Empty_Selected.png")));
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					mm.setEmptyIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Empty.png")));
					mm.setPlayerIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Player.png")));
					mm.setGoalIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Goal.png")));
					mm.setWallIcon(new ImageIcon(mapMaker.class.getResource("/map_maker/res/Wall.png")));
					mm.initialize();
